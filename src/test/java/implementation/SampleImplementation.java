...
public class SampleImplementation extends DriverAction {
    ...
    public void typeTextIntoLastName(String typeText) {
        ...
        try{
			waitUntilElementAppear(Sample.lastName,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyLastNameIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.lastName));
    ...
    public void typeTextIntoHeading(String typeText) {
        ...
        try{
			waitUntilElementAppear(Sample.heading,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyHeadingIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.heading));
    ...
    public void typeTextIntoBirthday(String typeText) {
        ...
        try{
			waitUntilElementAppear(Sample.birthday,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyBirthdayIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.birthday));
    ...
    public void verifyCssIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.css));
    ...
    public void verifyCssIsSelected() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.css,true));
    ...
    public String getAttributeFromCss(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.css,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void elementIsClickableCss() {
        //The below function is for web element @FindBy(Sample.css);
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.css));
        	GemTestReporter.addTestStep("Check if css is clickable","css is clickable", STATUS.PASS, takeSnapShot());
        			Settings.LOGGER.info("css is clickable");}
		catch(Exception e){
			GemTestReporter.addTestStep("Check if css is clickable","css is not clickable", STATUS.FAIL, takeSnapShot());
        			Settings.LOGGER.info("css is not clickable");};
    }
    ...
    public void verifyJavascriptIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.javascript));
    ...
    public void verifyJavascriptIsSelected() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.javascript,true));
    ...
    public String getAttributeFromJavascript(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.javascript,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void elementIsClickableJavascript() {
        //The below function is for web element @FindBy(Sample.javascript);
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.javascript));
        	GemTestReporter.addTestStep("Check if javascript is clickable","javascript is clickable", STATUS.PASS, takeSnapShot());
        			Settings.LOGGER.info("javascript is clickable");}
		catch(Exception e){
			GemTestReporter.addTestStep("Check if javascript is clickable","javascript is not clickable", STATUS.FAIL, takeSnapShot());
        			Settings.LOGGER.info("javascript is not clickable");};
    }
    ...
    public void elementIsClickableBike() {
        ...
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.Bike));
    ...
    public String getAttributeFromBike(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.Bike,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyElementSelectedForBike() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.Bike,true));
    ...
    public void verifyElementNotSelectedForBike() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.Bike,false));
			text = getAttributeName(Sample.Bike, "checked");
        	if(text==null){
    ...
    public void elementIsClickableBoat() {
        ...
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.Boat));
    ...
    public String getAttributeFromBoat(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.Boat,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyElementSelectedForBoat() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.Boat,true));
    ...
    public void verifyElementNotSelectedForBoat() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.Boat,false));
			text = getAttributeName(Sample.Boat, "checked");
        	if(text==null){
    ...
    public void selectCar(String typeText) {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.elementSelectionStateToBe(Sample.car,true));
    ...
    public void verifyCarIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.car));
    ...
    public void elementIsClickableCar() {
        ...
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.car));
    ...
    public String getAttributeFromCar(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.car,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void elementIsClickableSubmit() {
        ...
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.Submit));
    ...
    public String getAttributeFromSubmit(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.Submit,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifySubmitIsEnabled() {
        ...
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.Submit));
			getElement(Sample.Submit).isEnabled();
        	GemTestReporter.addTestStep("Verify Submit field is enabled","Submit field is enabled", STATUS.PASS, takeSnapShot());
        	Settings.LOGGER.info("Submit field is enabled");}
		catch(Exception e){
			GemTestReporter.addTestStep("Verify Submit field is enabled","S field is not enabled", STATUS.FAIL, takeSnapShot());
        	Settings.LOGGER.info("Submit field is not enabled");};
    }
    ...
    public void elementIsClickableHtml() {
        ...
        try{
			WebDriverWait wait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds((long) 10));
        	wait.until(ExpectedConditions.elementToBeClickable(Sample.html));
    ...
    public String getAttributeFromHtml(String attributeValue) {
        ...
        String text = new String();
        try{
			waitUntilElementAppear(Sample.html,Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut")));
    ...
    public void verifyHtmlIsEnabled() {
        //The below function is for web element @FindBy(Sample.html);
        try{
			WebDriverWait webDriverWait = new WebDriverWait(DriverManager.getWebDriver(), Duration.ofSeconds(Integer.parseInt(UtilsMethodCodeGenerator.readProperties("timeOut"))));
			webDriverWait.until(ExpectedConditions.presenceOfElementLocated(Sample.html));
			getElement(Sample.html).isEnabled();
        	GemTestReporter.addTestStep("Verify html field is enabled","html field is enabled", STATUS.PASS, takeSnapShot());
        	Settings.LOGGER.info("html field is enabled");}
		catch(Exception e){
			GemTestReporter.addTestStep("Verify html field is enabled","H field is not enabled", STATUS.FAIL, takeSnapShot());
        	Settings.LOGGER.info("html field is not enabled");};
    }
